...
# Download配下が無ければ cwd/takusen/data にフォールバック (Actions/PC対応)
if not os.path.isdir(_TAKUSEN_DATA):
    _cwd_td = os.path.join(os.getcwd(), "takusen", "data")
    if os.path.isdir(_cwd_td):
        _TAKUSEN_DATA = _cwd_td
